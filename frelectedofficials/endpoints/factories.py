...
class MunicipalCouncillor(ElectedOfficials):
    """Concrete implementation of the ElectedOfficials class for Municipal Councillor elected officials."""

    url: str = 'https://static.data.gouv.fr/resources/repertoire-national-des-elus-1/20260811-154802/elus-conseiller-municipal-cm.csv'
    filename: str = 'elus-conseiller-municipal-cm.csv'
    fr_title: str = "Élus Conseiller Municipal"
