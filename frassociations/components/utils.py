...
def dataframe_to_models(df: pandas.DataFrame) -> list[AssociationModel]:
...
def paginate[T = AssociationModel](limit: int = 100, offset: int = 0, values: Sequence[T] = ()) -> tuple[list[T], PaginationInfo]:
    limit = min(limit, 100)
